/** 
 * @(#)ProjectController.java 1.0.0 2016年1月5日 下午1:41:33  
 *  
 ...
 *  
 * @author  wangjf
 * @version $Revision:1.0.0, $Date: 2016年1月5日 下午1:41:33 $ 
 */
@RestController
@AutoDispatch(serviceInterface= {ProjectService.class})
@RequestMapping("project")
public class ProjectController extends WelcomeController {
