...
public class SystemArchitecture {
	 ...
	 * the com.slfinance.web package or any sub-package under that.
	 */
	@Pointcut("within(com.slfinance..controller..*)")
	public void inWebLayer() {
	}

	/**
	 * A join point is in the service layer if the method is defined in a type
	 * in the com.slfinance.thirdpp.service package or any sub-package under
	 * that.
	 */
	@Pointcut("within(com.slfinance..service..*)")
	public void inServiceLayer() {
	}

	/**
	 * A join point is in the data access layer if the method is defined in a
	 * type in the com.slfinance.thirdpp.dao package or any sub-package under
	 * that.
	 */
	@Pointcut("within(com.slfinance..dao..*)")
	 ...
	 * "execution(* com.slfinance.thirdpp..service..(..))" could be used
	 * instead.
	 *
	 ...
	 */
	@Pointcut("execution(* com.slfinance..service..*(..))")
	 ...
	 */
	@Pointcut("execution(* com.slfinance..dao..*(..))")
