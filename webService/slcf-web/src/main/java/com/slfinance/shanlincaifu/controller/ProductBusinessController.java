 ...
 * 
 * @author caoyi
 * @version $Revision:1.0.0, $Date: 2015年05月04日 下午20:41:25 $
 */
@RestController
@AutoDispatch(serviceInterface= {ProductBusinessService.class})
@RequestMapping("productBusiness")
public class ProductBusinessController extends WelcomeController{
