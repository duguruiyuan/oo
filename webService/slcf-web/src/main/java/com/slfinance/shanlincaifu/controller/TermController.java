/** 
 * @(#)TermController.java 1.0.0 2015年8月18日 下午2:54:12  
 *  
 ...
 *  
 * @author  wangjf
 * @version $Revision:1.0.0, $Date: 2015年8月18日 下午2:54:12 $ 
 */
@RestController
@AutoDispatch(serviceInterface= {TermService.class})
@RequestMapping("term")
public class TermController extends WelcomeController {
