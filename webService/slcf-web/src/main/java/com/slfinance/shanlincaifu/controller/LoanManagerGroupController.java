...
@RestController
@AutoDispatch(serviceInterface= {LoanManagerGroupService.class})
@RequestMapping("loanManagerGroup")
public class LoanManagerGroupController extends WelcomeController  {
