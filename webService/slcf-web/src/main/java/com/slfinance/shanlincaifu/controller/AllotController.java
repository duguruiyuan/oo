/** 
 * @(#)AllotController.java 1.0.0 2015年5月6日 下午2:05:57  
 *  
 ...
 *  
 * @author  wangjf
 * @version $Revision:1.0.0, $Date: 2015年5月6日 下午2:05:57 $ 
 */
@RestController
@AutoDispatch(serviceInterface= {AllotService.class})
@RequestMapping("allot")
public class AllotController extends WelcomeController{
