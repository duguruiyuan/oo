/** 
 * @(#)LoanController.java 1.0.0 2015年5月6日 上午11:05:39  
 *  
 ...
 *  
 * @author  wangjf
 * @version $Revision:1.0.0, $Date: 2015年5月6日 上午11:05:39 $ 
 */
@RestController
@AutoDispatch(serviceInterface= {LoanInfoService.class})
@RequestMapping("loan")
public class LoanController extends WelcomeController{
